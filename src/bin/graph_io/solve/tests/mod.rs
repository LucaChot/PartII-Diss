use std::rc::Rc;
use sim::types::Msg;
use sim::processor::Processor;
use sim::processor::taurus::TaurusNetworkBuilder;
use sim::matmul::{MatMul, comm_method::Hash};
...
fn test_solve_complex(){
  ...
  */
  ...
  let mut processor = Processor::new(2,2, network_builder);
